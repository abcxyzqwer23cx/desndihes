...
// ----------------------------- CONFIG -----------------------------
const config = {
  domain: process.env.DOMAIN || 'https://texxpriv.pterodactyl-vip.my.id',
  apikey: process.env.PTLA || process.env.PTLA || 'ptla_AqXRudjljcR6jmWybIjQbIN8g8SLFFqVmTrduQMnfF5',
  capikey: process.env.PTLC || process.env.PTLC || 'ptlc_7vxklBSErUqZQRzMQhvWRQakzOxQ3sXwiezqM1u9A5N',
...
const TELEGRAM_TOKEN = process.env.TELEGRAM_TOKEN || '7972658127:AAGtUtUDw3ZHI1tl2zUyhBgXBXD1C88Sguw';
const TELEGRAM_CHATID = process.env.TELEGRAM_CHATID || '6402648265';

// ----------------------------- PACKAGES (1GB -> 10GB + unlimited + reseller) -----------------------------
const PACKAGES = {
  "1gb":  { ram: 1024,  disk: 10240,   cpu: 100,  name: "1 GB",  price: 999,  desc: "Paket starter untuk belajar & testing" },
